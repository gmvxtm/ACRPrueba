...
(function($) {
	...
	if ( $.isFunction( $.fn[ 'dataTable' ] ) ) {
		...
		$.extend(true, $.fn.dataTable.defaults, {
		    sDom: "<'row datatables-header form-inline'<'col-sm-6 col-md-6 col-xs-12 text-left'f><'col-sm-6 col-md-6 col-xs-12'l>r><'table-responsive't><'row datatables-footer'<'col-sm-12 col-md-6'i><'col-sm-12 col-md-6'p>>",
			oLanguage: {
